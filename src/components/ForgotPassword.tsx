...
const ForgotPassword = ({ onClose, onSwitchToLogin, onSwitchToVerify }: ForgotPasswordProps) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/30">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-[600px] p-12 relative flex flex-col items-center">
        ...
        {!showOtpInput ? (
          ...
          <form onSubmit={handleVerifyOtp} className="flex flex-col items-center space-y-6 w-full">
            <input
              type="text"
